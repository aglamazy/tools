...
- עסקאות מט"ח (עסקה שבוצעה במטבע זר): הגיליון עשוי להכיל שתי עמודות סכום נפרדות — "סכום עסקה"/"מטבע עסקה" (הסכום המקורי במטבע חוץ, למשל 200.00 $) ו-"סכום חיוב"/"מטבע חיוב" (הסכום שחויב בפועל בשקלים, למשל 607.21 ₪). amount חייב תמיד להיות הסכום בשקלים מעמודת "סכום חיוב" — לעולם לא הסכום במטבע החוץ מעמודת "סכום עסקה", גם אם הוא מופיע ראשון בשורה. כאשר amount הוא הסכום בשקלים, currency הוא תמיד "ILS".
- שורות בטבלת "עסקאות שטרם נקלטו" (transactions not yet settled): לטבלה הזו אין בכלל עמודת "סכום חיוב"/"מטבע חיוב" — יש בה רק את הסכום במטבע המקורי, כי העסקה טרם הומרה סופית לשקלים (ההמרה תופיע רק בדוח החודש הבא). אל תכלול שורות כאלה ב-transactions בכלל אם המטבע המקורי אינו שקל — אין לנחש או להעתיק את הסכום הזר כאילו הוא כבר סכום בשקלים; עדיף להשמיט את השורה כליל.
