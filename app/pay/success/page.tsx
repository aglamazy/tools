/**
 * Public payment-success page (#73). YPAY redirects here (inside our iframe)
 * after a successful charge. The webhook is the source of truth for
 * reconciliation; this is just the payer-facing confirmation.
 */
  ...
  return (
    <div style={{
      ...
      <div style={{ background: 'white', borderRadius: '0.75rem', boxShadow: '0 10px 40px rgba(15,23,42,0.08)', border: '1px solid #e2e8f0', padding: '2rem', textAlign: 'center', maxWidth: 420 }}>
        ...
        <h1 style={{ color: '#059669', margin: '0.5rem 0', fontSize: '1.4rem' }}>התשלום בוצע בהצלחה</h1>
        <p style={{ color: '#64748b', margin: 0 }}>תודה! הקבלה תישלח אליך במייל.</p>
      </div>
    </div>
  )
}
