...
export const ACTION_DECLARATIONS: FunctionDeclaration[] = [
  ...
  {
    name: 'remove_items',
    description: 'הסר פריטים מההזמנה השבועית. "בלי X" / "השבוע בלי X"',
    parameters: {
      type: 'object',
      properties: {
  ...
  {
    name: 'show_list',
    description: 'הצג/תראה רשימת קניות של חנות. משמש ל"תראה את הרשימה", "מה ברשימה". חובה — אסור לרשום פריטים בתגובה.',
    parameters: {
      type: 'object',
      properties: {
        store: { type: 'string' },
