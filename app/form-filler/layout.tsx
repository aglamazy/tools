...
export const metadata: Metadata = {
  ...
  robots: { index: false, follow: false, googleBot: { index: false, follow: false, 'max-video-preview': -1, 'max-image-preview': 'large', 'max-snippet': -1 } },
  alternates: {
    canonical: '/form-filler',
    languages: {
      'he-IL': '/form-filler',
      'x-default': '/form-filler',
    },
  },
  openGraph: {
    title: `מילוי טפסים | ${branding.name}`,
    ...
    type: 'website',
    locale: 'he_IL',
    images: [{ url: '/logo.png', width: 2816, height: 1536, alt: `${branding.name} - מילוי טפסים` }],
  },
  twitter: {
    card: 'summary_large_image',
    title: `מילוי טפסים | ${branding.name}`,
    description: `כלי מילוי טפסים אוטומטי של ${branding.name}.`,
    images: ['/logo.png'],
  },
}
